...
namespace LibUsbDotNet_RWAsyncTestDemo
{
    class Program
    {
        ...
        public static UsbDeviceFinder MyUsbFinder = new UsbDeviceFinder(0x0951, 0x1666);
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    Debug.WriteLine("Read:"+Encoding.Default.GetString(readBuffer)+"=-=");
